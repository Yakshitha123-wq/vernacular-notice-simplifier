...
- Kesireddy Padma — frontend
- Arnab Acharya — backend / AWS pipeline
- Ujaan Mukherjee — backend support / bug fixing

## Credits

We used AI coding assistants (including OpenCode/Kimi and Claude Code) to help debug, refactor, and draft documentation. The team reviewed and tested all generated code before committing.
